...
El proyecto es una implementacion en C++ que simula una flota de automoviles dentro de una entidad estacionamiento, aplicando conceptos fundamentales de la Programacion Orientada a Objetos (POO), como lo es la herencia, polimorfismo y la agregacion.
...
3. Reporte de caracteristicas: Se llama a 
